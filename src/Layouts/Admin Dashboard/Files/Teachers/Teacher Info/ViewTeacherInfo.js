    ...
    const timerId = setTimeout(() => {
      ...
      const chartsData = () => {
        ...
        const fileForImg = () => {
            axios({
                method: "POST",
                url: `https://www.syntics.co/api/file/display/${location.state.imgReference}`,
                responseType: "blob"
              })
        ...
        const fileForCv = () => {
            axios({
                method: "POST",
                url: `https://www.syntics.co/api/file/display/${location.state.cvReference}`,
                responseType: "blob"
              })
          ...
          const fileForVid = () => {
            axios({
                method: "POST",
                url: `https://www.syntics.co/api/file/display/${location.state.vidReference}`,
                responseType: "blob"
              })
