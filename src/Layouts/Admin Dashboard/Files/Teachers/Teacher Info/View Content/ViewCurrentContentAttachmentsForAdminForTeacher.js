    ...
    const handlingAttachments = () => {
        if(location.state.answertype == "Drawing"){
            ...
            return(
                ...
                <div class="p-3 mb-2 bg-light text-dark">
                    <audio src={`https://www.syntics.co/api/file/display/${location.state.referenceName}`}  controls="controls" className="" type="audio/mpeg"  />
                </div>
                <hr />
            </div> 
            )
            ...
            return(
                <div className = "mt-4">
                        ...
                        <div class="p-3 mb-2 bg-light text-dark">
                            <video controls width="400" src = {`https://www.syntics.co/api/file/display/${location.state.referenceName}`}  type="video/webm" />
                        </div>
                        <hr />
                    </div>
            )
