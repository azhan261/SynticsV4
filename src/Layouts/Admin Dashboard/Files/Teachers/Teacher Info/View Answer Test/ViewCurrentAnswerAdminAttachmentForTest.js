...
function ViewCurrentAnswerAdminAttachmentForTest() {
    ...
    const handlingAttachments = () => {
        if(location.state.answertype == "Drawing"){
            return(
                <div className = "mt-4">
                        ...
                        <div class="p-3 mb-2 bg-light text-dark">
                            <img width="350" className = "text-dark" style={{textDecoration : "none", fontWeight: "bold",  boxShadow: "5px 5px #888888"}} src={`https://www.syntics.co/api/file/display/${location.state.questionReferenceName}`}>
                            </img>
                        </div>
                        <hr />
                    </div>
            ...
            return(
                ...
                <div class="p-3 mb-2 bg-light text-dark">
                    <audio src={`https://www.syntics.co/api/file/display/${location.state.questionReferenceName}`}  controls="controls" className="" type="audio/mpeg"  />
                </div>
                <hr />
            </div> 
            )
            ...
            return(
                <div className = "mt-4">
                        ...
                        <div class="p-3 mb-2 bg-light text-dark">
                            <video controls width="400" src = {`https://www.syntics.co/api/file/display/${location.state.questionReferenceName}`}  type="video/webm" />
                        </div>
                        <hr />
                    </div>
            )
    ...
    const handlingAnswerAttachments = () => {
        if(location.state.answertype == "Drawing"){
            ...
            <div class="p-3 mb-2 bg-light text-dark">
                <img width="350" className = "text-dark" style={{textDecoration : "none", fontWeight: "bold",  boxShadow: "5px 5px #888888"}} src={`https://www.syntics.co/api/file/display/${location.state.referenceName}`}>
                </img>
            </div>
            <hr />
        </div>
