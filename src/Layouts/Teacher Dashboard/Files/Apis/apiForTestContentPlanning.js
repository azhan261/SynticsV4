...
export const getTestPlanningsForGrade1 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-1/${id}`)
		.then(res => res.data, )
)
...
export const getTestPlanningsForGrade2 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-2/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningsForGrade3 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-3/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningsForGrade4 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-4/${id}`)
		.then(res => res.data, )
)
...
export const getTestPlanningsForGrade5 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-5/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningsForGrade6 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-6/${id}`)
		.then(res => res.data, )
)
...
export const getTestPlanningsForGrade7 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-7/${id}`)
		.then(res => res.data, )
)
...
export const getTestPlanningsForGrade8 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-8/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningsForGrade9 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-9/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningsForGrade10 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-10/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningsForGrade11 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-11/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningsForGrade12 = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/Grade-12/${id}`)
		.then(res => res.data, )
)
...
export const getTestPlanningAdmin = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/admin/${id}`)
		.then(res => res.data, )
)

export const getTestPlanningTeacherSpecific = id => (
	console.log(id),
	axios.post(`https://www.syntics.co/testPlannings/teacherSpecific/${id}`)
		.then(res => res.data, )
)