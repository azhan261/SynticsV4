...
//export const getRegistrations = () => fetch("https://www.syntics.co/").then(res => res.json())
...
//export const getRegisterationStudents = (id) => fetch(`https://www.syntics.co/students/specific/${id}`).then(res => res.json())
...
//export const getRegisterationStudentsById = (id) => fetch(`https://www.syntics.co/students/specific/id/${id}`).then(res => res.json())